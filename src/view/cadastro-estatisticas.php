...
<div class="mt-5">
    <h1><?= isset($estatisticas) && $estatisticas->getId() ? 'Editar Estatísticas' : 'Cadastro de Estatísticas' ?></h1>
    ...
    <form id="formEstatisticas" action="<?= BASE_URL ?>/estatisticas/cadastrar" method="POST">
